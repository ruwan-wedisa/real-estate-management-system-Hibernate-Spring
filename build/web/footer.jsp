        ...
        <div class="modal-content">
            <div class="row">
                <div class="col-sm-6 login">
                    <h4>Login</h4>
                    <form class="" name="form2" action="actionLogin.jsp" method="POST">
                        <div class="form-group">
                            <label class="sr-only" for="exampleInputEmail2">User Name</label>
                            <input type="text" class="form-control" id="exampleInputEmail2" name="userName" placeholder="Enter userName" required>
                        </div>
                        <div class="form-group">
